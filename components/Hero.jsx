...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center px-2 md:px-5 lg:px-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center w-full gap-10">
        ...
        <div className="tracking-wide text-xl md:text-2xl flex-1 text-center md:text-left order-2 md:order-1">
          <h2>
            ...
            <span className="text-[var(--primary)] text-shadow-[0px_0px_15px_rgb(0,0,0)] text-shadow-green-400"> Michael Christianto</span>
          </h2>
          ...
          <Link
            href="#contact"
            className="inline-block border-2 px-4 py-2 rounded-xl cursor-pointer capitalize hover:border-[var(--primary)] transition-all hover:text-[var(--primary)] hover:drop-shadow-[0px_0px_15px_rgb(0,0,0)] hover:drop-shadow-green-400"
          >
            contact me !!
          </Link>
        </div>
